...
class UserModel extends Model
{
     ...
     *
     * @return array message in error case and transport to index.php with $_SESSION data in succes case
     */
     ...
     * Log out
     *
     *  Destroy session and transport to login.php
     */
     ...
     * @param string $password password
     *
     * @return array Return message in error case and create new user in DB in succes case
     */
